...
#ifdef WHICHSUBEXPRESSION
#ifdef WITHZLIB
	PADPOSITION(54,11,24,25,sizeof(SHvariables));
#else
	PADPOSITION(52,11,24,25,sizeof(SHvariables));
#endif
#else
#ifdef WITHZLIB
	PADPOSITION(53,9,24,23,sizeof(SHvariables));
#else
	PADPOSITION(51,9,24,23,sizeof(SHvariables));
#endif
#endif
#else
#ifdef WHICHSUBEXPRESSION
#ifdef WITHZLIB
	PADPOSITION(52,9,24,25,sizeof(SHvariables));
#else
	PADPOSITION(50,9,24,25,sizeof(SHvariables));
#endif
#else
#ifdef WITHZLIB
	PADPOSITION(51,7,24,23,sizeof(SHvariables));
#else
	PADPOSITION(49,7,24,23,sizeof(SHvariables));
#endif
#endif
#endif
};
