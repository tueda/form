...
**
* Enable cache read/write.
*
*#define CacheRead
*#define CacheWrite

**
* Skip checking whether the cache exists.
*
*#define CacheSkipCheck

**
* Specify the cache directory.
*
*#define CacheDir "CACHE_DIRECTORY_PATH"

**
* Terminate execution with a non-zero status if diagrams differ.
*
*#define RaiseError

#ifndef `CacheDir'
  #define CacheDir "./.diagrams_cache"
#endif

#ifdef `TESTFILEDIR'
  #redefine CacheDir "`TESTFILEDIR'/.diagrams_cache"
#endif
...
*     then write the cache file.
        ...
        #system awk "
          # For lines containing topo_, normalize the leading spaces
          ...
          # Other lines are considered as continuation lines.
          # Remove leading spaces and concatenate the line to the previous line
  ...
  #if (`ZERO_F1' == 1) && (`ZERO_F2' == 1)
    #message INFO: Diagrams from FORM and `DiagramGeneratorName' are consistent.
  #else
    #message ERROR: Diagrams from FORM and `DiagramGeneratorName' differ.
    #ifdef `RaiseError'
      #terminate
    #endif
  #endif
