...
.end
assert preprocess_error?
assert stdout =~ exact_pattern("Improper syntax of #continuedo instruction")
*--#] Issue243_e2 : 
*--#[ Issue243_e3 :
#do i=1,3
  #continuedo 1a
...
.end
assert preprocess_error?
assert stdout =~ exact_pattern("Too many loop levels requested in #continuedo instruction")
*--#] Issue243_e4 : 
*--#[ Issue243_e5 :
#procedure foo
  #continuedo
...
.end
assert preprocess_error?
assert stdout =~ exact_pattern("Trying to jump out of a procedure with a #continuedo instruction")
*--#] Issue243_e5 : 
*--#[ Issue243_e6 :
#procedure foo
  #continuedo 2
